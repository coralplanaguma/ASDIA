...
$$
![Un réseau de neurones artificiels. Le réseau prend une variable de dimension 3 en entrée et la classe en deux catégories (softmax) en sortie. Il y a une couche cachée possédant 4 neurones.](./Artificial_neural_network.svg.png)
...
# commenter et compléter les lignes suivantes  
  model %>% compile(
    ...
    optimizer = optimizer_rmsprop(lr = 0.001, rho = O, decay = 0),
