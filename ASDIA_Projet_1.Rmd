...
Or, on a montré que $\mathbb{E}[L(q_{opt}({\bf x}), y)|x] \geq h(q_{opt})$. Donc d'après les résultats qui précèdent, $q_{opt}$ minimise l'espérance $\mathbb{E}[L(q_{opt}({\bf x}), y)]$
